...
option_hair_color = st.sidebar.selectbox('Hair color',
                                         ...
                                         key='hair_color')
option_hat_color = st.sidebar.selectbox('Color',
                                         list_hat_color,
...
option_facial_hair_type = st.sidebar.selectbox('Facial hair type',
                                                ...
                                                key='facial_hair_type')
option_facial_hair_color = st.sidebar.selectbox('HairColor',
